...
`,U={root:function(t){var o=t.props,r=t.instance;return["p-badge p-component",{"p-badge-circle":O(o.value)&&String(o.value).length===1,"p-badge-dot":w(o.value)&&!r.$slots.default,"p-badge-sm":o.size==="small","p-badge-lg":o.size==="large","p-badge-xl":o.size==="xlarge","p-badge-info":o.severity==="info","p-badge-success":o.severity==="success","p-badge-warn":o.severity==="warn","p-badge-danger":o.severity==="danger","p-badge-secondary":o.severity==="secondary","p-badge-contrast":o.severity==="contrast"}]}},Z=x.extend({name:"badge",style:V,classes:U}),H={name:"BaseBadge",extends:S,props:{value:{type:[String,Number],default:null},severity:{type:String,default:null},size:{type:String,default:null}},style:Z,provide:function(){return{$pcBadge:this,$parentInstance:this}}};function l(n){"@babel/helpers - typeof";return l=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(t){return typeof t}:function(t){return t&&typeof Symbol=="function"&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},l(n)}function k(n,t,o){return(t=M(t))in n?Object.defineProperty(n,t,{value:o,enumerable:!0,configurable:!0,writable:!0}):n[t]=o,n}function M(n){var t=R(n,"string");return l(t)=="symbol"?t:t+""}function R(n,t){if(l(n)!="object"||!n)return n;var o=n[Symbol.toPrimitive];if(o!==void 0){var r=o.call(n,t);if(l(r)!="object")return r;throw new TypeError("@@toPrimitive must return a primitive value.")}return(t==="string"?String:Number)(n)}var z={name:"Badge",extends:H,inheritAttrs:!1,computed:{dataP:function(){return p(k(k({circle:this.value!=null&&String(this.value).length===1,empty:this.value==null&&!this.$slots.default},this.severity,this.severity),this.size,this.size))}}},q=["data-p"];function G(n,t,o,r,h,d){return i(),g("span",u({class:n.cx("root"),"data-p":d.dataP},n.ptmi("root")),[b(n.$slots,"default",{},function(){return[T(P(n.value),1)]})],16,q)}z.render=G;var J=({dt:n})=>`
.p-button {
    display: inline-flex;
    cursor: pointer;
    user-select: none;
